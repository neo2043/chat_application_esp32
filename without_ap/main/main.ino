...
//wifi creds defined here
#include "passwd/password.h"

#define HTTP_PORT 80
const char* PARAM_INPUT_1 = "name";
staticArray<String> nameArray;
staticArray<int> clientIDArray;
...
void handleWebSocketMessage(void *arg, uint8_t *data, size_t len) {
    Serial.println("/////////////////////////////////////////////");
    Serial.println("function handleWebSocketMessage start");
    ...
    Serial.println("function handleWebSocketMessage done");
    Serial.println("/////////////////////////////////////////////");
}
...
void newClientConnect(int clientID){
    Serial.println("/////////////////////////////////////////////");
    Serial.println("function newClientConnect start");
    ...
    ws.textAll(data,len);
    Serial.println("function newClientConnect done");
    Serial.println("/////////////////////////////////////////////");
}

void clientDisconnect(int clientID){
    Serial.println("/////////////////////////////////////////////");
    Serial.println("function clientDisconnect start");
    ...
    nameArray.printArray();
    Serial.println("function clientDisconnect done");
    Serial.println("/////////////////////////////////////////////");
}
...
void clientName(AsyncWebServerRequest *request){
    Serial.println("/////////////////////////////////////////////");
    Serial.println("function clientName start");
    String inputMessage;
    ...
    Serial.println("function clientName done");
    Serial.println("/////////////////////////////////////////////");
}

void nameList(AsyncWebServerRequest *request){
    Serial.println("/////////////////////////////////////////////");
    Serial.println("function nameList start");
    ...
    Serial.println("function nameList done");
    Serial.println("/////////////////////////////////////////////");
}
